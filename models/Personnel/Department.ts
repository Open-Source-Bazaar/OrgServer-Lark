...
export class DepartmentModel extends BiDataTable<Department>() {
  ...
  get tree() {
    ...
    const tempMap = Object.fromEntries(tempList) as Record<string, DepartmentNode>;
...
export class SearchDepartmentModel extends BiSearch<Department>(DepartmentModel) {
